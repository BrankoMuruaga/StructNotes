...
function Navbar() {
  return (
    <nav className="fixed top-0 z-20 flex bg-secondary-light dark:bg-secondary-dark w-full py-1 rounded-b-xl ">
      <MenuButton className="z-30 ml-3" />
      <section
        id="tool_bar"
        className="fixed bottom-10 w-full h-10 z-10 sm:block sm:top-0 sm:w-1/6 flex justify-center sm:ml-16 "
      >
